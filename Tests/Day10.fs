...
module Part1 =
  ...
  *)
  ...
  [<Fact>]
  let ``Sample`` () =
    solvePart1 [0..4] [3; 4; 1; 5;]
    |> should equal 12

  [<Fact>]
  let ``Answer`` () =
    solvePart1 [0..255] [46;41;212;83;1;255;157;65;139;52;39;254;2;86;0;204;]
    |> should equal 52070
...
module Part2 =
  ...
  *)
  ...
  [<Fact>]
  let ``Answer`` () =
    asHexadecimal "46,41,212,83,1,255,157,65,139,52,39,254,2,86,0,204"
    |> should equal "7f94112db4e32e19cf6502073c66f9bb"
