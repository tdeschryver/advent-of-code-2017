...
[<Fact>]
let ``Example.`` () =
  Assert.Equal(18, Day02.checksumMinMax "
5 1 9 5
7 5 3
2 4 6 8")
...
[<Fact>]
let ``Input.`` () =
  Assert.Equal(37923, Day02.checksumMinMax "
...
[<Fact>]
let ``Example part 2.`` () =
  Assert.Equal(9, Day02.checksumDivisible "
5 9 2 8
9 4 7 3
3 8 6 5")
...
[<Fact>]
let ``Input part 2.`` () =
  Assert.Equal(263, Day02.checksumDivisible "
1136	1129	184	452	788	1215	355	1109	224	1358	1278	176	1302	186	128	1148
242	53	252	62	40	55	265	283	38	157	259	226	322	48	324	299
2330	448	268	2703	1695	2010	3930	3923	179	3607	217	3632	1252	231	286	3689
89	92	903	156	924	364	80	992	599	998	751	827	110	969	979	734
